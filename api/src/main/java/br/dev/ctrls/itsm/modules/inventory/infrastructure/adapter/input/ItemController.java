package br.dev.ctrls.itsm.modules.inventory.infrastructure.adapter.input;
...
import br.dev.ctrls.itsm.infrastructure.shared.storage.FileStorageService;
import br.dev.ctrls.itsm.infrastructure.shared.storage.InvoiceFileMetadata;
import br.dev.ctrls.itsm.modules.inventory.application.dto.AllocateConsumableRequestDTO;
import br.dev.ctrls.itsm.modules.inventory.application.dto.BatchResponseDTO;
import br.dev.ctrls.itsm.modules.inventory.application.dto.ItemAllocationResponseDTO;
import br.dev.ctrls.itsm.modules.inventory.application.dto.ItemRequestDTO;
import br.dev.ctrls.itsm.modules.inventory.application.dto.ItemResponseDTO;
import br.dev.ctrls.itsm.modules.inventory.application.dto.LinkComponentRequestDTO;
import br.dev.ctrls.itsm.modules.inventory.application.dto.StockBatchRequestDTO;
import br.dev.ctrls.itsm.modules.inventory.application.dto.StockBatchResponseDTO;
import br.dev.ctrls.itsm.modules.inventory.application.dto.StockMovementResponseDTO;
import br.dev.ctrls.itsm.modules.inventory.application.usecase.AllocateConsumableUseCase;
import br.dev.ctrls.itsm.modules.inventory.application.usecase.CreateItemUseCase;
import br.dev.ctrls.itsm.modules.inventory.application.usecase.FindItemByIdUseCase;
import br.dev.ctrls.itsm.modules.inventory.application.usecase.LinkAssetComponentUseCase;
import br.dev.ctrls.itsm.modules.inventory.application.usecase.ListAllItemsUseCase;
import br.dev.ctrls.itsm.modules.inventory.application.usecase.ListItemBatchesUseCase;
import br.dev.ctrls.itsm.modules.inventory.application.usecase.RegisterStockBatchUseCase;
import br.dev.ctrls.itsm.modules.inventory.domain.model.Item;
import br.dev.ctrls.itsm.modules.inventory.domain.model.ItemAllocationEntity;
import br.dev.ctrls.itsm.modules.inventory.domain.model.StockBatch;
import br.dev.ctrls.itsm.modules.inventory.domain.model.StockMovementType;
...
import br.dev.ctrls.itsm.modules.inventory.domain.port.output.StockMovementRepositoryPort;
import br.dev.ctrls.itsm.modules.inventory.infrastructure.adapter.output.jpa.repository.ItemAllocationJpaRepository;
