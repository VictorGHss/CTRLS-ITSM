...
import br.dev.ctrls.itsm.modules.appointment.application.usecase.HandleBlipWebhookUseCase;
...
public class BlipWebhookController {
    ...
    private final br.dev.ctrls.itsm.modules.appointment.domain.port.output.AppointmentSessionRepositoryPort appointmentSessionRepository;
    private final br.dev.ctrls.itsm.modules.access.domain.service.AccessService accessService;
