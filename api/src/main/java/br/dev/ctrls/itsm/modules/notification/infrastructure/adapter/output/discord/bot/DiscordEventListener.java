        ...
        discordExecutor.execute(() -> {
            try {
                ...
                if (resultados.isEmpty()) {
                    List<br.dev.ctrls.itsm.modules.knowledge.domain.model.Article> artigos = discordCommandService.buscarArtigos(busca);
                    if (artigos.isEmpty()) {
                        ...
                        for (br.dev.ctrls.itsm.modules.knowledge.domain.model.Article artigo : artigos) {
