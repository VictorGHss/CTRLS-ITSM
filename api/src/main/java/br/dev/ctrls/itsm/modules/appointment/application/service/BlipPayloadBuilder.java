...
import br.dev.ctrls.itsm.modules.appointment.application.dto.AudienceDto;
import br.dev.ctrls.itsm.modules.appointment.application.dto.CampaignDto;
import br.dev.ctrls.itsm.modules.appointment.application.dto.MessageDto;
...
public class BlipPayloadBuilder {
    ...
    public static String formatE164Recipient(String rawPhone) {
        ...
        String e164 = br.dev.ctrls.itsm.modules.appointment.infrastructure.utils.StringSanitizer.formatE164(rawPhone);
