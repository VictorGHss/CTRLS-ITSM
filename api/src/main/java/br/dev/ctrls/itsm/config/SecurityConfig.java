...
import br.dev.ctrls.itsm.infrastructure.shared.web.filter.ManualTriggerKeyFilter;
import br.dev.ctrls.itsm.infrastructure.shared.web.filter.RawBodyLoggingFilter;
import br.dev.ctrls.itsm.infrastructure.shared.web.filter.SecurityFilter;
...
public class SecurityConfig {
    ...
    private final br.dev.ctrls.itsm.infrastructure.shared.web.filter.BlipTokenSecurityFilter blipTokenSecurityFilter;
