...
import br.dev.ctrls.itsm.modules.inventory.infrastructure.adapter.output.jpa.repository.ItemJpaRepository;
...
public class ItemRepositoryAdapter implements ItemRepositoryPort {
    ...
    @Override
    public java.util.List<br.dev.ctrls.itsm.modules.inventory.domain.model.Item> findTop25ByNameContainingIgnoreCase(String name) {
