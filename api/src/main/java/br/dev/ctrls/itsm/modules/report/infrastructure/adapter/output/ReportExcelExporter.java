...
import br.dev.ctrls.itsm.modules.report.application.dto.TicketReportDTO;
...
public class ReportExcelExporter implements ReportExcelExporterPort {
    ...
    @Override
    public byte[] exportInventoryExitsToExcel(List<br.dev.ctrls.itsm.modules.report.application.dto.OutflowReportRowDTO> rows) {
        try (XSSFWorkbook workbook = new XSSFWorkbook()) {
