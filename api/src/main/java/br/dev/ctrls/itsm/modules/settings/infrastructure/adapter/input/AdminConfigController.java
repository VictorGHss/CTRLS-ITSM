...
public class AdminConfigController {
    ...
    private final br.dev.ctrls.itsm.modules.notification.infrastructure.adapter.output.discord.DiscordWebhookService discordWebhookService;
    private final br.dev.ctrls.itsm.modules.appointment.infrastructure.config.FeegowProperties feegowProperties;
    private final br.dev.ctrls.itsm.modules.finance.infrastructure.config.ContaAzulProperties contaAzulProperties;
    private final br.dev.ctrls.itsm.modules.appointment.infrastructure.config.AppointmentMotorProperties appointmentMotorProperties;
