package br.dev.ctrls.itsm.modules.ticket.infrastructure.adapter.input;
...
import br.dev.ctrls.itsm.infrastructure.shared.storage.LocalFileStorageService;
import br.dev.ctrls.itsm.modules.ticket.application.dto.ResolveTicketDTO;
import br.dev.ctrls.itsm.modules.ticket.application.dto.TicketAttachmentResponseDTO;
import br.dev.ctrls.itsm.modules.ticket.application.dto.TicketCommentRequestDTO;
import br.dev.ctrls.itsm.modules.ticket.application.dto.TicketCommentResponseDTO;
import br.dev.ctrls.itsm.modules.ticket.application.dto.TicketRequestDTO;
import br.dev.ctrls.itsm.modules.ticket.application.dto.TicketResponseDTO;
import br.dev.ctrls.itsm.modules.ticket.application.dto.UpdateSolutionTextDTO;
import br.dev.ctrls.itsm.modules.ticket.application.dto.UpdateTicketItemsDTO;
import br.dev.ctrls.itsm.modules.ticket.application.usecase.AddAdditionalUserUseCase;
import br.dev.ctrls.itsm.modules.ticket.application.usecase.AddTicketCommentUseCase;
import br.dev.ctrls.itsm.modules.ticket.application.usecase.ChangeCategoryUseCase;
import br.dev.ctrls.itsm.modules.ticket.application.usecase.ClaimTicketUseCase;
import br.dev.ctrls.itsm.modules.ticket.application.usecase.CreateTicketUseCase;
import br.dev.ctrls.itsm.modules.ticket.application.usecase.FetchTicketsByItemUseCase;
import br.dev.ctrls.itsm.modules.ticket.application.usecase.FindSimilarTicketsUseCase;
import br.dev.ctrls.itsm.modules.ticket.application.usecase.FindTicketByIdUseCase;
import br.dev.ctrls.itsm.modules.ticket.application.usecase.GetTicketCommentsUseCase;
import br.dev.ctrls.itsm.modules.ticket.application.usecase.LinkTicketUseCase;
import br.dev.ctrls.itsm.modules.ticket.application.usecase.ListAllTicketsUseCase;
import br.dev.ctrls.itsm.modules.ticket.application.usecase.ResolveTicketUseCase;
import br.dev.ctrls.itsm.modules.ticket.application.usecase.TransferTicketUseCase;
import br.dev.ctrls.itsm.modules.ticket.application.usecase.UpdateSolutionTextUseCase;
import br.dev.ctrls.itsm.modules.ticket.application.usecase.UpdateTicketItemsUseCase;
import br.dev.ctrls.itsm.modules.ticket.domain.model.Ticket;
import br.dev.ctrls.itsm.modules.ticket.domain.model.TicketAttachment;
import br.dev.ctrls.itsm.modules.ticket.domain.model.TicketPriority;
import br.dev.ctrls.itsm.modules.ticket.domain.model.TicketStatus;
import br.dev.ctrls.itsm.modules.ticket.domain.port.output.TicketAttachmentRepositoryPort;
