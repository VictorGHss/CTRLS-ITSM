package br.dev.ctrls.itsm.modules.ticket.domain.model;
...
import br.dev.ctrls.itsm.infrastructure.shared.security.CryptoConverter;
...
public class Ticket {
    ...
    private Set<br.dev.ctrls.itsm.modules.user.domain.model.User> additionalUsers = new HashSet<>();
    ...
    private Set<br.dev.ctrls.itsm.modules.user.domain.model.User> assignedUsers = new HashSet<>();

    /** Ativo (CMDB) associado a este chamado, se aplicável. */
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "asset_id")
    private br.dev.ctrls.itsm.modules.asset.domain.model.Asset asset;
