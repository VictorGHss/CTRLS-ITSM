package br.dev.ctrls.itsm.modules.asset.application.service;
...
import br.dev.ctrls.itsm.modules.finance.domain.model.FinancialTransaction;
import br.dev.ctrls.itsm.modules.finance.domain.port.FinancialTransactionRepository;
import br.dev.ctrls.itsm.modules.finance.domain.port.FinancialLinkRepository;
...
public class AssetMaintenanceService {
    ...
    public AssetMaintenanceResponseDTO create(UUID assetId, AssetMaintenanceRequestDTO request, User technician) {
        ...
        br.dev.ctrls.itsm.modules.ticket.domain.model.Ticket ticket = null;
