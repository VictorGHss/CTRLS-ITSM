...
public class BlipNotificationService {
    ...
    public BlipNotificationService(
            ...
            BlipAppointmentFormatter blipAppointmentFormatter,
            BlipReviewNotificationService blipReviewNotificationService,
            br.dev.ctrls.itsm.modules.appointment.domain.port.output.DoctorConfigurationRepository doctorConfigurationRepository,
            br.dev.ctrls.itsm.modules.appointment.domain.port.output.AppointmentDoctorMappingRepositoryPort appointmentDoctorMappingRepository) {
        this(limeClient, blipTemplateParameterResolver, motorProperties, blipPayloadBuilder, blipContextService,
    ...
    private void validateBlipResponse(Map<String, Object> response, String templateName, String recipient) {
        if (response == null || response.isEmpty()) {
            ...
            throw new br.dev.ctrls.itsm.modules.appointment.domain.exception.BlipNotificationException(
