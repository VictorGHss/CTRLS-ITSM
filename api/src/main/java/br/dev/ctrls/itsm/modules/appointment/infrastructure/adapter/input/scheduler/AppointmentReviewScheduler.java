...
import br.dev.ctrls.itsm.modules.appointment.application.service.SendPostAppointmentReviewUseCase;
...
public class AppointmentReviewScheduler {
    ...
    @Scheduled(cron = "${app.review.cron:0 0/30 8-18 * * MON-SAT}", zone = "America/Sao_Paulo")
