package br.dev.ctrls.itsm.modules.knowledge.infrastructure.adapter.input;
...
import br.dev.ctrls.itsm.modules.knowledge.application.dto.ArticleRequestDTO;
import br.dev.ctrls.itsm.modules.knowledge.application.dto.ArticleResponseDTO;
import br.dev.ctrls.itsm.modules.knowledge.application.dto.ArticleSearchResultDTO;
...
public class ArticleController {
    ...
    public ResponseEntity<List<ArticleResponseDTO>> listAll() {
        ...
        List<Article> articles = user.getRole() == br.dev.ctrls.itsm.modules.user.domain.model.UserRole.USER
    ...
    public ResponseEntity<ArticleResponseDTO> getById(@PathVariable UUID id) {
        User user = getAuthenticatedUser();
            ...
            boolean canReadDraft = article.getStatus() != ArticleStatus.DRAFT
                    ...
                    || user.getRole() == br.dev.ctrls.itsm.modules.user.domain.model.UserRole.ADMIN;
