...
import br.dev.ctrls.itsm.modules.asset.domain.model.AssetFilterStatus;
import br.dev.ctrls.itsm.modules.asset.domain.model.AssetSortBy;
...
public class AssetQueryService {
    ...
    public java.util.List<AssetResponseDTO> findAssetsByUser(
            UUID userId,
            br.dev.ctrls.itsm.modules.asset.domain.port.output.AssetRepositoryPort assetRepository) {
    ...
    public AssetResponseDTO getAssetById(
        ...
        Asset asset = assetRepository.findById(id)
                .orElseThrow(() -> new br.dev.ctrls.itsm.core.shared.domain.model.exception.NotFoundException("Asset not found with id: " + id));
