package br.dev.ctrls.itsm.modules.vault.infrastructure.adapter.output;
...
import br.dev.ctrls.itsm.modules.vault.infrastructure.adapter.output.jpa.repository.VaultItemShareJpaRepository;
...
public class VaultItemShareRepositoryAdapter implements VaultItemShareRepositoryPort {
    ...
    @Override
    public java.util.List<VaultItemShare> saveAll(java.util.List<br.dev.ctrls.itsm.modules.vault.domain.model.VaultItemShare> shares) {
