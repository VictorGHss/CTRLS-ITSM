...
public class ListAllTicketsUseCase {
    ...
    public org.springframework.data.domain.Page<TicketResponseDTO> execute(
        ...
        org.springframework.data.jpa.domain.Specification<br.dev.ctrls.itsm.modules.ticket.domain.model.Ticket> spec = 
            br.dev.ctrls.itsm.modules.ticket.application.service.TicketSpecification.filterTickets(
                restrictionId,
                tagIds,
                search,
                status,
