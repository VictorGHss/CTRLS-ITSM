...
import br.dev.ctrls.itsm.modules.inventory.infrastructure.adapter.output.jpa.repository.StockBatchJpaRepository;
...
public class StockBatchRepositoryAdapter implements StockBatchRepositoryPort {
    ...
    @Override
    public java.util.List<StockBatch> saveAll(java.util.List<br.dev.ctrls.itsm.modules.inventory.domain.model.StockBatch> batches) {
        return repository.saveAll(batches);
    }

    @Override
    public java.util.List<StockBatch> findByItemOrderByEntryDateDesc(br.dev.ctrls.itsm.modules.inventory.domain.model.Item item) {
