...
public class SendPreAppointmentNoticeUseCase {
    ...
    private final br.dev.ctrls.itsm.modules.appointment.application.service.BlipContextService blipContextService;
    private final br.dev.ctrls.itsm.modules.appointment.domain.port.output.AppointmentExternalPort appointmentExternalPort;
    ...
    private final br.dev.ctrls.itsm.modules.appointment.application.service.AppointmentFilterService appointmentFilterService;
    ...
    public void execute() {
        ...
        List<br.dev.ctrls.itsm.modules.appointment.application.dto.FeegowLockDto> activeLocks = 
