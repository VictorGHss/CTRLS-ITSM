...
import br.dev.ctrls.itsm.modules.asset.domain.port.output.AssetCategoryRepositoryPort;
...
import br.dev.ctrls.itsm.modules.inventory.application.service.StockDeductionService;
...
import br.dev.ctrls.itsm.modules.ticket.domain.event.TicketResolvedEvent;
...
public class ResolveTicketUseCase {
        ...
        private final br.dev.ctrls.itsm.modules.finance.application.service.FinancialService financialService;
