...
public class DiscordTicketService {
    ...
    private final br.dev.ctrls.itsm.modules.asset.domain.port.output.AssetRepositoryPort assetRepository;
    private final br.dev.ctrls.itsm.modules.ticket.domain.port.output.TicketTagRepositoryPort ticketTagRepository;
    private final br.dev.ctrls.itsm.modules.ticket.domain.model.TicketTagExtractor ticketTagExtractor;
    ...
    public String createTicketFromDiscord(String discordUserId, String titleInput, String descriptionInput, String priorityRaw, String patrimonioOption) {
        ...
        br.dev.ctrls.itsm.modules.asset.domain.model.Asset asset = null;
        ...
        java.util.Set<br.dev.ctrls.itsm.modules.ticket.domain.model.TicketTag> extractedTags = ticketTagExtractor.extractTags(title, storedDescription);
        ...
        if (asset != null && asset.isCritical()) {
            ...
            br.dev.ctrls.itsm.modules.ticket.domain.model.TicketTag criticalTag = ticketTagRepository.findByNameIgnoreCase("#🚨ParadaCrítica").orElseGet(() -> {
                br.dev.ctrls.itsm.modules.ticket.domain.model.TicketTag newTag = br.dev.ctrls.itsm.modules.ticket.domain.model.TicketTag.builder()
                        .name("#🚨ParadaCrítica")
                        .color("#EF4444")
                        .active(true)
        ...
        eventPublisher.publishEvent(new br.dev.ctrls.itsm.modules.ticket.domain.event.TicketCreatedEvent(savedTicket, new java.util.ArrayList<>()));
