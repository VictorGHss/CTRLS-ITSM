package br.dev.ctrls.itsm.modules.report.application.service;
...
import br.dev.ctrls.itsm.modules.report.domain.port.output.ReportExcelExporterPort;
...
public class ReportService {
    ...
    private final br.dev.ctrls.itsm.modules.inventory.domain.port.output.StockMovementRepositoryPort stockMovementRepository;
    private final br.dev.ctrls.itsm.modules.inventory.domain.port.output.ItemRepositoryPort itemRepository;
    private final br.dev.ctrls.itsm.modules.asset.domain.port.output.AssetMaintenanceRepositoryPort assetMaintenanceRepository;
    private final br.dev.ctrls.itsm.modules.ticket.domain.port.output.TicketRepositoryPort ticketRepository;
    ...
    private List<OutflowReportRowDTO> buildUnifiedExitRows(java.time.LocalDateTime start, java.time.LocalDateTime end) {
            ...
            for (Ticket ticket : requestTickets) {
                ...
                try {
                    ...
                    var movements = stockMovementRepository.findByReferenceStartingWithAndTypeOrderByDateDesc(
                            refPrefix, br.dev.ctrls.itsm.modules.inventory.domain.model.StockMovementType.OUT);
        ...
        try {
            List<br.dev.ctrls.itsm.modules.inventory.domain.model.StockMovement> movements =
                    stockMovementRepository.findByDateBetweenAndTypeOrderByDateDesc(
                            start, end, br.dev.ctrls.itsm.modules.inventory.domain.model.StockMovementType.OUT);
        ...
        try {
            List<br.dev.ctrls.itsm.modules.asset.domain.model.AssetMaintenance> maintenances =
