...
public interface StockBatchRepositoryPort {
    ...
    java.util.List<StockBatch> saveAll(java.util.List<br.dev.ctrls.itsm.modules.inventory.domain.model.StockBatch> batches);
    java.util.List<StockBatch> findByItemOrderByEntryDateDesc(br.dev.ctrls.itsm.modules.inventory.domain.model.Item item);
}
