...
class BlipTemplateResponseParsingTest {
    ...
    void shouldResolveBreadcrumbFromDatabaseFallbackWhenContextIsNull() {
        br.dev.ctrls.itsm.modules.appointment.domain.port.output.AppointmentSessionRepositoryPort repoMock =
        ...
        br.dev.ctrls.itsm.modules.appointment.domain.model.AppointmentSession sessionMock =
                mock(br.dev.ctrls.itsm.modules.appointment.domain.model.AppointmentSession.class);
