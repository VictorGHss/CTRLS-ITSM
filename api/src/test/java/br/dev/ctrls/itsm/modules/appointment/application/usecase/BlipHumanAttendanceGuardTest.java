...
import br.dev.ctrls.itsm.config.security.WebhookSignatureValidator;
import br.dev.ctrls.itsm.modules.appointment.application.service.BlipContextService;
import br.dev.ctrls.itsm.modules.appointment.application.service.BlipDeskGuardService;
...
import br.dev.ctrls.itsm.modules.appointment.application.service.BlipWebhookIdempotencyService;
import br.dev.ctrls.itsm.modules.appointment.application.service.BlipWebhookInboundService;
import br.dev.ctrls.itsm.modules.appointment.application.service.BlipWebhookIntentMatcher;
import br.dev.ctrls.itsm.modules.appointment.infrastructure.adapter.input.rest.BlipWebhookController;
...
class BlipHumanAttendanceGuardTest {
    ...
    void setUp() {
        ...
        br.dev.ctrls.itsm.modules.appointment.application.service.BlipContextPayloadFactory payloadFactory =
                new br.dev.ctrls.itsm.modules.appointment.application.service.BlipContextPayloadFactory();
        ...
        br.dev.ctrls.itsm.modules.appointment.domain.port.output.AppointmentSessionRepositoryPort appointmentSessionRepository =
                mock(br.dev.ctrls.itsm.modules.appointment.domain.port.output.AppointmentSessionRepositoryPort.class);
        br.dev.ctrls.itsm.modules.access.domain.service.AccessService accessService = mock(br.dev.ctrls.itsm.modules.access.domain.service.AccessService.class);
